class O1010000Node < Formula
  desc "node.js dependency for Particle's o1010000 experimental CLI"
  homepage "https://docs.particle.io"
  ...
  keg_only "o1010000-node is only used by Particle's o1010000 experimental CLI, which explicitly requires from Cellar"
